...
function Menu() {
  ...
  const {currentBalance, currentOverdrawn, overdrawnLimit} = useCustomer();
  ...
  return (
    <section className="flex flex-col justify-center text-primary h-full px-10">
      ...
      <ul className='mb-5'>
        <li>
          <b>You current balance:</b> £{currentBalance}
        </li>
        <li>
          <b>You current overdrawn:</b> £{currentOverdrawn}
        </li>
        <li>
          <b>You overdrawn limit:</b> £{overdrawnLimit}
        </li>
      </ul>
      <h2 className="text-xl mb-3">Select an operation:</h2>
      <section className="flex justify-between w-full">
        <button className="bg-secondary hover:bg-secondary-dark active:bg-secondary-light w-[45%] py-2 rounded-md"
